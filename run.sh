...
# for angle_vale in 0.091 0.182 0.273 0.364 0.419 0.455 0.546
#     do 
...
do
    ...
    foamCloneCase sonicFoam convergence_${num_xcells}_${num_ycells}
    cd convergence_${num_xcells}_${num_ycells}
